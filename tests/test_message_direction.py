...
def test_build_message_records_uses_sender_mapping_for_direction() -> None:
    ...
    rows = [
        (336, 1, 1776689079, 3, 661, "示例消息 A", "", None),
        (338, 1, 1776689108, 3, 5, "示例消息 B", "", None),
        (380, 1, 1776821512, 2, 5, "示例消息 C", "", None),
    ]
    sender_name_map = {
        5: "wxid_self",
        661: "wxid_peer",
    ...
    assert [message.sender for message in messages] == ["测试联系人", "Me", "Me"]
